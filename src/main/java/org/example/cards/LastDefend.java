...
public class LastDefend extends CustomCard {
    public static final String ID = ModHelper.makePath(LastDefend.class.getSimpleName());
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        int blockAmount = maxHealth - currentHealth;
        this.addToBot(new GainBlockAction(p, blockAmount));
    }
}
